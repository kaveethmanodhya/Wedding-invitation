                                    ...
                                    {[1, 2, 3, 4, 5].map(num => (
                                      <button 
                                        ...
                                        className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm transition-all shadow-sm ${
                                          formData.guests === String(num) ? 'bg-[#C9956A] text-white scale-110' : 'bg-white text-slate-400 hover:bg-slate-100'
                                        }`}
                                      >
                                        {num}
                                      </button>
                                    ...
                                    {[
                                      ...
                                      >
                                         <div className={`w-5 h-5 rounded-md border flex items-center justify-center transition-all ${
                                           formData.dietary[opt.id] ? 'bg-[#C9956A] border-[#C9956A]' : 'bg-white border-slate-200'
                                         }`}>
